        ...
        for i in range(n):
            ...
            if row[4] >= 0.5:
                ...
                if self.class_to_label(labels[i]) == 'Without Helmet':
                    ...
                    nPlateCascade = cv2.CascadeClassifier(r"C:\Users\91984\Downloads\Helmet-detection-and-number-plate-capturing-main (1)\Helmet-detection-and-number-plate-capturing-main\haarcascade\haarcascade_russian_plate_number.xml")
